...
export default function Page() {
  ...
  const [recentTournaments, setRecentTournaments] = useState<Tournaments[]>([]);
  ...
  useEffect(() => {
    async function fetchTournaments() {
      ...
      setRecentTournaments(recentTournaments.value);
      setLoading(false);
  ...
  function addTournament(tournament: Tournaments) {
    setRecentTournaments((prev) => [...prev, tournament]);
  }
